...
func TestConfigDir(t *testing.T) {
	...
	expectedSamples := []string{
		`{"completed":"false","event_type":"commandJsonOutSample","id":1,"integration_name":"com.kav91.nri-flex",` +
			`"integration_version":"0.3.9-pre","myCustomAttr":"theValue","title":"delectus aut autem","userId":1}`}
...
func TestE2E_Vault(t *testing.T) {
	...
	expectedSample :=
		`{"baseUrl":"http://127.0.0.1:32768/v1/","event_type":"vaultStatus","health.api.StatusCode":200,` +
			...
			`"integration_version":"0.3.9-pre","key.api.StatusCode":200,"key.auth":"\u003cnil\u003e","key.data.install_time":"2019-02-16T13:44:21.716366Z",` +
...
func TestRedis(t *testing.T) {
	...
	expectedSamples := []string{
		`{"activeDefragHits":0,"activeDefragKeyHits":0,"activeDefragKeyMisses":0,"activeDefragMisses":0,"activeDefragRunning":0,` +
			...
			`"instantaneousOutputKbps":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","keyspaceHits":1,` +
...
func TestE2E_PrometheusQueryMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"api.StatusCode":200,"baseUrl":"http://localhost:9090/api/v1","data.resultType":"vector","event_type":"promTestQuerySample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9090","metric.job":"prometheus","status":"success","timestamp":1435781451,"value":1}`,
		`{"api.StatusCode":200,"baseUrl":"http://localhost:9090/api/v1","data.resultType":"vector","event_type":"promTestQuerySample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9100","metric.job":"node","status":"success","timestamp":1435781451,"value":0}`,
	}
...
func TestE2E_rometheusQueryRangeMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9090","metric.job":"prometheus","status":"success","timestamp":1435781430,"value":1}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781430,"value":0}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781445,"value":0}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781460,"value":1}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
...
func TestE2E_PrometheusPTargetsMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"baseUrl":"http://localhost:9090/api/v1/","discoveredLabels.__address__":"127.0.0.1:9090","discoveredLabels.__metrics_path__":"/metrics","discoveredLabels.__scheme__":"http","discoveredLabels.job":"prometheus","event_type":"promTestPTargetsSample","health":"up","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","labels.instance":"127.0.0.1:9090","labels.job":"prometheus","lastError":"","lastScrape":"2017-01-17T15:07:44.723715405+01:00","scrapeUrl":"http://127.0.0.1:9090/metrics","status":"success"}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","discoveredLabels.__address__":"127.0.0.1:9100","discoveredLabels.__metrics_path__":"/metrics","discoveredLabels.__scheme__":"http","discoveredLabels.job":"node","event_type":"promTestPTargetsSample","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","status":"success"}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
...
func TestE2E_Etcd(t *testing.T) {
	...
	load.Entity, _ = i.Entity("TestEtcd", "nri-flex")
	expectedSamples := []string{
		`{"baseUrl":"http://127.0.0.1:2379/v2/","counts.fail":0,"counts.success":745,"event_type":"etcdLeaderSample","follower.id":"6e3bd23ae5f1eae0","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","latency.average":0.017039507382550306,"latency.current":0.000138,"latency.maximum":1.007649,"latency.minimum":0,"latency.standardDeviation":0.05289178277920594,"leader":"924e2e83e93f2560","myCustomAttr":"theValue"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","counts.fail":0,"counts.success":735,"event_type":"etcdLeaderSample","follower.id":"a8266ecf031671f3","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","latency.average":0.012124141496598642,"latency.current":0.000559,"latency.maximum":0.791547,"latency.minimum":0,"latency.standardDeviation":0.04187900156583733,"leader":"924e2e83e93f2560","myCustomAttr":"theValue"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","event_type":"etcdSelfSample","id":"eca0338f4ea31566","integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","leaderInfo.leader":"8a69d5f6b7814500","leaderInfo.startTime":"2014-10-24T13:15:51.186620747-07:00","leaderInfo.uptime":"10m59.322358947s","name":"node3","recvAppendRequestCnt":5944,"recvBandwidthRate":570.6254930219969,"recvPkgRate":9.00892789741075,"sendAppendRequestCnt":0,"startTime":"2014-10-24T13:15:50.072007085-07:00","state":"StateFollower"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","compareAndSwapFail":0,"compareAndSwapSuccess":0,"createFail":0,"createSuccess":2,"deleteFail":0,"deleteSuccess":0,"event_type":"etcdStoreSample","expireCount":0,"getsFail":4,"getsSuccess":75,"integration_name":"com.kav91.nri-flex","integration_version":"0.3.9-pre","setsFail":2,"setsSuccess":4,"updateFail":0,"updateSuccess":0,"watchers":0}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
