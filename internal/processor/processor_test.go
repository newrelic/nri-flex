...
func TestConfigDir(t *testing.T) {
	...
	expectedSamples := []string{
		`{"completed":"false","event_type":"commandJsonOutSample","id":1,"integration_name":"com.kav91.nri-flex",` +
			`"integration_version":"0.4.8-pre","myCustomAttr":"theValue","title":"delectus aut autem","userId":1}`}
...
func TestE2E_Vault(t *testing.T) {
	...
	expectedSample :=
		`{"baseUrl":"http://127.0.0.1:32768/v1/","event_type":"vaultStatus","health.api.StatusCode":200,` +
			...
			`"integration_version":"0.4.8-pre","key.api.StatusCode":200,"key.auth":"\u003cnil\u003e","key.data.install_time":"2019-02-16T13:44:21.716366Z",` +
...
func TestE2E_ElasticSearch(t *testing.T) {
	...
	expectedSamples := []string{
		`{"baseUrl":"http://localhost:9200/","completion.size_in_bytes":0,"docs.count":0,"docs.deleted":0,"event_type":"elasticsearchTotalSample","fielddata.evictions":0,"fielddata.memory_size_in_bytes":0,"flush.periodic":0,"flush.total":10,"flush.total_time_in_millis":5,"get.current":0,"get.exists_time_in_millis":0,"get.exists_total":0,"get.missing_time_in_millis":0,"get.missing_total":0,"get.time_in_millis":0,"get.total":0,"indexing.delete_current":0,"indexing.delete_time_in_millis":0,"indexing.delete_total":0,"indexing.index_current":0,"indexing.index_failed":0,"indexing.index_time_in_millis":0,"indexing.index_total":0,"indexing.is_throttled":"false","indexing.noop_update_total":0,"indexing.throttle_time_in_millis":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","merges.current":0,"merges.current_docs":0,"merges.current_size_in_bytes":0,"merges.total":0,"merges.total_auto_throttle_in_bytes":209715200,"merges.total_docs":0,"merges.total_size_in_bytes":0,"merges.total_stopped_time_in_millis":0,"merges.total_throttled_time_in_millis":0,"merges.total_time_in_millis":0,"query_cache.cache_count":0,"query_cache.cache_size":0,"query_cache.evictions":0,"query_cache.hit_count":0,"query_cache.memory_size_in_bytes":0,"query_cache.miss_count":0,"query_cache.total_count":0,"recovery.current_as_source":0,"recovery.current_as_target":0,"recovery.throttle_time_in_millis":0,"refresh.listeners":0,"refresh.total":50,"refresh.total_time_in_millis":0,"request_cache.evictions":0,"request_cache.hit_count":0,"request_cache.memory_size_in_bytes":0,"request_cache.miss_count":0,"search.fetch_current":0,"search.fetch_time_in_millis":0,"search.fetch_total":0,"search.open_contexts":0,"search.query_current":0,"search.query_time_in_millis":0,"search.query_total":0,"search.scroll_current":0,"search.scroll_time_in_millis":0,"search.scroll_total":0,"search.suggest_current":0,"search.suggest_time_in_millis":0,"search.suggest_total":0,"segments.count":0,"segments.doc_values_memory_in_bytes":0,"segments.fixed_bit_set_memory_in_bytes":0,"segments.index_writer_memory_in_bytes":0,"segments.max_unsafe_auto_id_timestamp":-1,"segments.memory_in_bytes":0,"segments.norms_memory_in_bytes":0,"segments.points_memory_in_bytes":0,"segments.stored_fields_memory_in_bytes":0,"segments.term_vectors_memory_in_bytes":0,"segments.terms_memory_in_bytes":0,"segments.version_map_memory_in_bytes":0,"store.size_in_bytes":2610,"translog.earliest_last_modified_age":0,"translog.operations":0,"translog.size_in_bytes":1100,"translog.uncommitted_operations":0,"translog.uncommitted_size_in_bytes":550,"warmer.current":0,"warmer.total":20,"warmer.total_time_in_millis":1}`,
		`{"baseUrl":"http://localhost:9200/","completion.size_in_bytes":0,"docs.count":0,"docs.deleted":0,"event_type":"elasticsearchPrimarySample","fielddata.evictions":0,"fielddata.memory_size_in_bytes":0,"flush.periodic":0,"flush.total":10,"flush.total_time_in_millis":5,"get.current":0,"get.exists_time_in_millis":0,"get.exists_total":0,"get.missing_time_in_millis":0,"get.missing_total":0,"get.time_in_millis":0,"get.total":0,"indexing.delete_current":0,"indexing.delete_time_in_millis":0,"indexing.delete_total":0,"indexing.index_current":0,"indexing.index_failed":0,"indexing.index_time_in_millis":0,"indexing.index_total":0,"indexing.is_throttled":"false","indexing.noop_update_total":0,"indexing.throttle_time_in_millis":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","merges.current":0,"merges.current_docs":0,"merges.current_size_in_bytes":0,"merges.total":0,"merges.total_auto_throttle_in_bytes":209715200,"merges.total_docs":0,"merges.total_size_in_bytes":0,"merges.total_stopped_time_in_millis":0,"merges.total_throttled_time_in_millis":0,"merges.total_time_in_millis":0,"query_cache.cache_count":0,"query_cache.cache_size":0,"query_cache.evictions":0,"query_cache.hit_count":0,"query_cache.memory_size_in_bytes":0,"query_cache.miss_count":0,"query_cache.total_count":0,"recovery.current_as_source":0,"recovery.current_as_target":0,"recovery.throttle_time_in_millis":0,"refresh.listeners":0,"refresh.total":50,"refresh.total_time_in_millis":0,"request_cache.evictions":0,"request_cache.hit_count":0,"request_cache.memory_size_in_bytes":0,"request_cache.miss_count":0,"search.fetch_current":0,"search.fetch_time_in_millis":0,"search.fetch_total":0,"search.open_contexts":0,"search.query_current":0,"search.query_time_in_millis":0,"search.query_total":0,"search.scroll_current":0,"search.scroll_time_in_millis":0,"search.scroll_total":0,"search.suggest_current":0,"search.suggest_time_in_millis":0,"search.suggest_total":0,"segments.count":0,"segments.doc_values_memory_in_bytes":0,"segments.fixed_bit_set_memory_in_bytes":0,"segments.index_writer_memory_in_bytes":0,"segments.max_unsafe_auto_id_timestamp":-1,"segments.memory_in_bytes":0,"segments.norms_memory_in_bytes":0,"segments.points_memory_in_bytes":0,"segments.stored_fields_memory_in_bytes":0,"segments.term_vectors_memory_in_bytes":0,"segments.terms_memory_in_bytes":0,"segments.version_map_memory_in_bytes":0,"store.size_in_bytes":2610,"translog.earliest_last_modified_age":0,"translog.operations":0,"translog.size_in_bytes":1100,"translog.uncommitted_operations":0,"translog.uncommitted_size_in_bytes":550,"warmer.current":0,"warmer.total":20,"warmer.total_time_in_millis":1}`,
		`{"baseUrl":"http://localhost:9200/","event_type":"elasticsearchShardSample","failed":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","successful":10,"total":20}`,
		`{"active_primary_shards":10,"active_shards":10,"active_shards_percent_as_number":50,"baseUrl":"http://localhost:9200/","cluster_name":"docker-cluster","delayed_unassigned_shards":0,"event_type":"elasticsearchClusterHealthSample","initializing_shards":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","number_of_data_nodes":1,"number_of_in_flight_fetch":0,"number_of_nodes":1,"number_of_pending_tasks":0,"relocating_shards":0,"status":"yellow","task_max_waiting_in_queue_millis":0,"timed_out":"false","unassigned_shards":10}`,
		// `{"baseUrl":"http://localhost:9200/","event_type":"elasticsearchPendingClusterTaskSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre"}`,
...
func TestRedis(t *testing.T) {
	...
	expectedSamples := []string{
		`{"activeDefragHits":0,"activeDefragKeyHits":0,"activeDefragKeyMisses":0,"activeDefragMisses":0,"activeDefragRunning":0,` +
			...
			`"instantaneousOutputKbps":0,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","keyspaceHits":1,` +
...
func TestE2E_PrometheusQueryMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"api.StatusCode":200,"baseUrl":"http://localhost:9090/api/v1","data.resultType":"vector","event_type":"promTestQuerySample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9090","metric.job":"prometheus","status":"success","timestamp":1435781451,"value":1}`,
		`{"api.StatusCode":200,"baseUrl":"http://localhost:9090/api/v1","data.resultType":"vector","event_type":"promTestQuerySample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9100","metric.job":"node","status":"success","timestamp":1435781451,"value":0}`,
	}
...
func TestE2E_PrometheusQueryRangeMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9090","metric.job":"prometheus","status":"success","timestamp":1435781430,"value":1}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781430,"value":0}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781445,"value":0}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","data.resultType":"matrix","event_type":"promTestQueryRangeSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","metric.__name__":"up","metric.instance":"localhost:9091","metric.job":"node","status":"success","timestamp":1435781460,"value":1}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
...
func TestE2E_PrometheusPTargetsMetrics(t *testing.T) {
	...
	expectedSamples := []string{
		`{"baseUrl":"http://localhost:9090/api/v1/","discoveredLabels.__address__":"127.0.0.1:9090","discoveredLabels.__metrics_path__":"/metrics","discoveredLabels.__scheme__":"http","discoveredLabels.job":"prometheus","event_type":"promTestPTargetsSample","health":"up","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","labels.instance":"127.0.0.1:9090","labels.job":"prometheus","lastError":"","lastScrape":"2017-01-17T15:07:44.723715405+01:00","scrapeUrl":"http://127.0.0.1:9090/metrics","status":"success"}`,
		`{"baseUrl":"http://localhost:9090/api/v1/","discoveredLabels.__address__":"127.0.0.1:9100","discoveredLabels.__metrics_path__":"/metrics","discoveredLabels.__scheme__":"http","discoveredLabels.job":"node","event_type":"promTestPTargetsSample","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","status":"success"}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
...
func TestE2E_Etcd(t *testing.T) {
	...
	load.Entity, _ = i.Entity("TestEtcd", "nri-flex")
	expectedSamples := []string{
		`{"baseUrl":"http://127.0.0.1:2379/v2/","counts.fail":0,"counts.success":745,"event_type":"etcdLeaderSample","follower.id":"6e3bd23ae5f1eae0","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","latency.average":0.017039507382550306,"latency.current":0.000138,"latency.maximum":1.007649,"latency.minimum":0,"latency.standardDeviation":0.05289178277920594,"leader":"924e2e83e93f2560","myCustomAttr":"theValue"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","counts.fail":0,"counts.success":735,"event_type":"etcdLeaderSample","follower.id":"a8266ecf031671f3","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","latency.average":0.012124141496598642,"latency.current":0.000559,"latency.maximum":0.791547,"latency.minimum":0,"latency.standardDeviation":0.04187900156583733,"leader":"924e2e83e93f2560","myCustomAttr":"theValue"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","event_type":"etcdSelfSample","id":"eca0338f4ea31566","integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","leaderInfo.leader":"8a69d5f6b7814500","leaderInfo.startTime":"2014-10-24T13:15:51.186620747-07:00","leaderInfo.uptime":"10m59.322358947s","name":"node3","recvAppendRequestCnt":5944,"recvBandwidthRate":570.6254930219969,"recvPkgRate":9.00892789741075,"sendAppendRequestCnt":0,"startTime":"2014-10-24T13:15:50.072007085-07:00","state":"StateFollower"}`,
		`{"baseUrl":"http://127.0.0.1:2379/v2/","compareAndSwapFail":0,"compareAndSwapSuccess":0,"createFail":0,"createSuccess":2,"deleteFail":0,"deleteSuccess":0,"event_type":"etcdStoreSample","expireCount":0,"getsFail":4,"getsSuccess":75,"integration_name":"com.kav91.nri-flex","integration_version":"0.4.8-pre","setsFail":2,"setsSuccess":4,"updateFail":0,"updateSuccess":0,"watchers":0}`,
	}
	config := load.Config{
		Name: "Prom Range Test",
		Global: load.Global{
